  ...
  <section class="about-us">
    <div class="about-us-block">
      <div class="about-title-block">
        ...
        <p class="about-us-header"><?php echo $lang['about_us-text'] ?></p>
      </div>
      <img src="/assets/about-us.jpg" alt="" class="about-img">
    </div>
    <div class="our-benefits">
      <div class="title benefits">
        <h2><?php echo $lang['benefits-title'] ?></h2>
      </div>
      <div class="benefits-items">
        <div class="benefit-item">
          <img src="/assets/icons/door-icon.png" alt="">
          <p><?php echo $lang['benefits-text1'] ?></p>
        </div>
        <div class="benefit-item">
          <img src="/assets/icons/hand-icon.png" alt="">
          <p><?php echo $lang['benefits-text2'] ?></p>
        </div>
        <div class="benefit-item">
          <img src="/assets/icons/people-icon.png" alt="">
          <p><?php echo $lang['benefits-text3'] ?></p>
        </div>
        <div class="benefit-item">
          <img src="/assets/icons/quality-icon.png" alt="">
          <p><?php echo $lang['benefits-text4'] ?></p>
        </div>
      </div>
      <div class="description">
        <p><?php echo $lang['about-description1'] ?></p>
        <p><?php echo $lang['about-description2'] ?></p>
      </div>
    </div>
  </section>
