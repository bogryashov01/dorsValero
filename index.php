...
<body>
  ...
  <section class="door-tabs">
    ...
    <div class="doors-preview" id="doors-view"></div>
    <div class="door-link-more-block">
      <a href="/<?php echo $_SESSION['lang']; ?>/catalog" class="door-link-more"><?php echo $lang['more_button'] ?></a>
    </div>
  </section>
  <?php include('./components/footer.php') ?>
  <script src="/js/homeTabs.js"></script>
</body>
